...
public class Card implements ICard {
    ...
    @Override
    synchronized public void increaseBalance(double amount) throws IllegalArgumentException {
        checkAmountForCorrectValue(amount);
        this.balance += amount;
    }

    @Override
    synchronized public void decreaseBalance(double amount) throws IllegalArgumentException, IllegalArgumentValue {
        checkAmountForCorrectValue(amount);
        this.balance -= amount;
    }
